...
class ExampleSmall(IntegrationTest):
    ...
    def storage(self):
        self.helper_storage.select_disk('vda', False)  # Unselect disk
        self.installer.check_next_disabled()
        self.helper_storage.wait_no_disks()  # Error message visible
        self.helper_storage.select_disk('vda', True)  # Select disk
...
class ExampleLarge(IntegrationTest):
    def testInstall(self):
        ...
        self.storage()
        self.installer.next()
        self.installer.back()  # Return to storage screen
        self.installer.next()  # Immediately continue to review
        self.review()
