...
class WiredTUIConfigurationData():
    """Holds tui configuration data of wired device."""
    def __init__(self):
        self.ip = "dhcp"
        self.netmask = ""
        self.gateway = ""
    ...
    def set_from_connection(self, connection):
        ...
        if ip4_method == NM.SETTING_IP4_CONFIG_METHOD_AUTO:
            ...
            self.ip = "dhcp"
        self.gatway = ip4_config.get_gateway() or ""
        ...
        self.namesrver = ",".join(nameservers)
...
class NetworkSpoke(FirstbootSpokeMixIn, NormalTUISpoke):
    ...
    def _configure_connection(self, iface, connection_uuid):
        ...
        ui_data.iface = iface
        log.debug("{} -> {}".format(connection_uuid, ui_data))
