...
def _bound_hwaddr_of_device(devname):
    ...
    For example ifname=devname:f4:ce:46:2c:44:7a binds device name pxe to the
    MAC address (and renames the device eventually).  If hwaddress of the
    device devname is the same as the MAC address, its value is returned.
