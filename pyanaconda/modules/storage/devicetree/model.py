...
class InstallerStorage(Blivet):
    ...
    def _mark_protected_devices(self):
        ...
        if live_device:
            ...
            protected_w_ancestors.append(live_device)
        ...
        protected_w_ancestors.extend(dev for dev in self.devicetree.devices
                                     if dev.type == "cdrom")
        ...
        for dev in protected_w_ancestors:
            self._mark_protected_device(dev, ancestors=True)
