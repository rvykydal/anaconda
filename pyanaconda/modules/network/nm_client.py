...
def add_connection_from_ksdata(nm_client, network_data, device_name, activate=False, ifname_option_values=None):
    ...
    update_connection_ip_settings_from_ksdata(nm_client, con, network_data)
...
def update_connection_from_ksdata(nm_client, connection_uuid, network_data, device_name=None):
    ...
    # IP configuration
    update_connection_ip_settings_from_ksdata(nm_client, connection, network_data)
...
def update_connection_ip_settings_from_ksdata(nm_client, connection, network_data):
