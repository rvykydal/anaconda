...
class DeviceConfigurations(object):
    ...
    def add_connection(self, connection):
        ...
        iface = nm_client.get_iface_from_connection(uuid)
    ...
    def get_kickstart_data(self, network_data_class):
        # TODO slaves?
        # - hold in DeviceConfiguration?
        # - add slaves_ifcfgs property?
        #   - replace with function?
        #   - hanle elsewhere?
        # TODO --device specification is not preserved - do some clever tricks?
        # TODO don't touch kicstart_data unless UI has been used?
        rv = []
