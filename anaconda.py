...
def exitHandler(rebootData, storage):
    ...
    if not flags.imageInstall and not flags.dirInstall and conf.system.can_reboot:
...
if __name__ == "__main__":
    ...
    if conf.system.can_adjust_time_live:
    ...
    if conf.system.can_synchronize_time:
